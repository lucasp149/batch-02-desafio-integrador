...
contract UpCuyCollectionNft is
    Initializable,
    ERC721Upgradeable,
    PausableUpgradeable,
    ...
    UUPSUpgradeable
{
    ...
    bytes32 public root;
    // added
    mapping(uint256 => bool) private mintedWhiteList;
    ...
    function safeMintWhiteList(
        ...
        // added
         require(mintedWhiteList[tokenId] == false,
            "El token ya fue minteado"
        );

        _safeMint(to, tokenId);
        mintedWhiteList[tokenId] = true;
    }
